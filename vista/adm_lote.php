...
?>
  ...
  <title>Adm | Gestão lote </title>

  <?php
  include_once 'layouts/nav.php';
  ?>
  <!--Modal editar lote -->
  <div class="modal fade" id="editarlote" tabindex="-1" role="dialog" aria-labelledby="exampleModalL">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input id="stock"type="number" class="form-control" placeholder="Digite o stock" required>
                  </div>
        ...
        <div class="card card-success">
          <div class="card-header">
            ...
            <div class="input-group">
              <input type="text" id="buscar-lote"class="form-control float-left" placeholder="Digite o nome do produto">
