                    ...
                    <div class="card-body p-0">
                            ...
                            <div class="datos_cp">
                                <div class="form-group row">
                                    ...
                                    <div class="input-group-append col-md-6">
                                        <input type="text" class="form-control" id="cliente" placeholder="Digite  nome">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <span>DNI: </span>
                                    <div class="input-group-append col-md-6">
                                        <input type="number" class="form-control" id="dni" placeholder="Digite  DNI">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <span>Vendedor: </span>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="info-box mb-3 bg-warning">
                                                ...
                                                <div class="info-box-content">
                                                    ...
                                                    <span class="info-box-number"id="com_iva">2</span>
                                                </div>
                                            </div>
                                            <div class="info-box mb-3 bg-info">
                                                ...
                                                <div class="info-box-content">
                                                    ...
                                                    <span class="info-box-number" id="total_sem_desconto">12</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="info-box mb-3 bg-danger">
                                                ...
                                                <div class="info-box-content">
                                                    ...
                                                    <input id="desconto"type="number" min="1" placeholder="Digite o desconto" class="form-control">
                                                </div>
                                            </div>
                                            <div class="info-box mb-3 bg-info">
                                ...
                                <div class="col-md-4">
                                    <div class="card card-default">
                                        ...
                                        <div class="info-box mb-3 bg-success">
                                            ...
                                            <div class="info-box-content">
                                                <span class="info-box-text text-left ">PAGAMENTO</span>
                                                <input type="number" id="pago" min="1" placeholder="Digite Dinheiro" class="form-control">
                                        ...
                                        <div class="info-box mb-3 bg-info">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <span class="info-box-number" id="volto">3</span>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row justify-content-between">
                            ...
                            <div class="col-xs-12 col-md-4">
                                <a href="#" class="btn btn-success btn-block" id="processar_compra">Realizar compra</a>
                            </div>
                        </div>
                    </div>
                </div>
